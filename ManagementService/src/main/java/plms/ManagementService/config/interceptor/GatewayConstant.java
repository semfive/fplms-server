...
public class GatewayConstant {
    ...
    public static final String EMAIL_TEST = "kienfplms.fe@gmail.com";
    ...
    public static void addApiEntities() {
        ...
        apiEntities.add(new ApiEntity("deleteGroupByLecturer", "/api/management/classes/{classId:\\d+}/groups/{groupId:\\d+}", PUT_METHOD, ROLE_LECTURER));
