...
public class ClassService {
    ...
    public Response<String> createClass(ClassDTO classDTO) {
        ...
        return new Response<>(GatewayConstant.OK_STATUS, ServiceMessage.SUCCESS_MESSAGE);
    }
    ...
    public Response<Set<ClassDTO>> getClassOfLecture(String lectureEmail) {
        ...
        return new Response<>(GatewayConstant.OK_STATUS, ServiceMessage.SUCCESS_MESSAGE, classDTOSet);
    }
    ...
    public Response<Set<StudentInClassResponse>> getStudentInClass(Integer classId) {
        if (classId == null) {
            ...
            return new Response<>(GatewayConstant.BAD_REQUEST_STATUS, ServiceMessage.INVALID_ARGUMENT_MESSAGE);
        }
        ...
        if (studentSet == null) {
            ...
            return new Response<>(GatewayConstant.OK_STATUS, ServiceMessage.SUCCESS_MESSAGE, studentInClassResponseSet);
        }
    }
